...
const RightCardContent = (props) => {
  return (
    <div className='absolute top-0 left-0 h-full w-full  p-8 flex flex-col justify-between'>
        ...
        <div>
            <p className='text-lg leading-relaxed text-white mb-8'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur, odit veritatis mollitia ratione delectus porro!</p>
            <div className='flex justify-between'>
                <button className='bg-blue-600 text-white font-medium px-7 py-3 rounded-full
                text-lg'>{props.tag}</button>
                <button className='bg-blue-600 text-white font-medium px-3 py-2 rounded-full
                text-lg'><ArrowRight /></button>
            </div>
        </div>
    </div>
  )
